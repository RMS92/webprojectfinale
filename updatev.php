...
if(isset($_SESSION['id_vendeur']) )
{
     ...
     $requsermodif->execute(array($_SESSION['id_vendeur']));
     ...
     if(isset($_POST['newprenom']) AND !empty($_POST['newprenom']) AND $_POST['newprenom'] != $usermodif['prenom'])
     {
     	...
     	$insertprenom->execute(array($newprenom, $_SESSION['id_vendeur']));
      ...
      if(isset($_POST['newnom']) AND !empty($_POST['newnom']) AND $_POST['newnom'] != $usermodif['nom'])
     {
     	...
     	$insertnom->execute(array($newnom, $_SESSION['id_vendeur']));
     	header("Location: comptevendeur.php?id_vendeur=".$_SESSION['id_vendeur']);
     ...
     if(isset($_POST['newmail']) AND !empty($_POST['newmail']) AND $_POST['newmail'] != $usermodif['email'])
     {
     	...
     	if($mailexist == 0)
        {
     	    ...
     	    $insertmail->execute(array($newmail, $_SESSION['id_vendeur']));
     	    header("Location: comptevendeur.php?id_vendeur=".$_SESSION['id_vendeur']);
     	}
     	else
        {
     ...
     if(isset($_POST['newmdp']) AND !empty($_POST['newmdp']) AND isset($_POST['newmdp2']) AND !empty($_POST['newmdp2']))
     {
     	...
     	if($newmdp == $newmdp2)
     	{
     	    ...
     	    $insertmdp->execute(array($newmdp, $_SESSION['id_vendeur']));
     	    header("Location: comptevendeur.php?id_vendeur=".$_SESSION['id_vendeur']);
     	}
     	else
     	{
					...
					<div class="bandeau">
						<div class="bandeau_gauche">
							...
							<div class="formulaire" style="margin-top: 50px; margin-bottom: 25px">
						      ...
						      <input type="text" id="prenom" name="newprenom" value="<?php echo $usermodif['prenom']?>" placeholder="prenom">
						 		<br>
						 	  <input type="text" id="nom" name="newnom" value="<?php echo $usermodif['nom']?>" placeholder="nom">
						 		<br>
						      <input type="email" id="email" name="newmail"  value="<?php echo $usermodif['email']?>"placeholder="email non modifiable">
						 		<br>
						      ...
						      <input type="date" id="date_anniversaire" value="<?php echo $usermodif['date_anniversaire']?>" name="newdate">
						      <br>
