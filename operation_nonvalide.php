...
<body>
	...
	<div class="milieu">
		...
		<div class="container" style="background-color: red;border: 1px solid silver;margin-top :30px; margin-bottom: 30px; width: 675px;height: 175px;text-align: center; font-size: 25px; margin: auto">
			
			Votre opération n'a pas été validée !
			<br>
			<p >
			<img src="images/error.png" alt="marche po" height="135px" width="135px" align="center">
			</p>
		</div>
		<div class="container" style="background-color: white; margin-top :60px; margin-bottom: 30px; width: 475px;height: 220px;text-align: center; font-size: 25px; margin: auto">
			...
			<img src="images/flecherouge.png" alt="marche po" height="200px" width="200px" align="center" style="margin-top: 40px;">
			</p>
		</div>
