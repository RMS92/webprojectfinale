						...
						<div class="bandeau_gauche">
							...
							<div class="formulaire" style="margin-top: 50px; margin-bottom: 25px">
						      ...
						      <br>
                                ...
                                <a href="<?php echo "updateadmin.php?id_vendeur=".$userinfosA['id_vendeur']."" ?>"><input type="button" value="Change informations" style="background-color: black; color: white;" /> </a>
